...
// Utility functions moved from inline to top-level for better performance
...
const getDeptName = (key: string): string => {
...
const getDepartmentBreakdown = (history: any[], summaryInfo?: any) => {
